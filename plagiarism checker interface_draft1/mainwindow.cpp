...
for (auto it = a.getnewx().begin(); it != a.getnewx().end(); ++it)
{

        ui->file_1_log->setText(ui->file_1_log->text()+"\n"+"("+it->first+")");

}

for (auto t = a.getnewy().begin(); t != a.getnewy().end(); ++t)
{

        ui->file_2_log->setText(ui->file_2_log->text()+"\n"+"("+t->first+")");
